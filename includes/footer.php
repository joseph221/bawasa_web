    ...
    <div class="container">
        ...
        <div class="footer-bottom">
            <ul class="list-inline text-center">
                ...
                <li class="list-inline-item  py-2"><a href="/sitemap" class="btn btn-primary btn-sm">Sitemap</a></li>
                <li class="list-inline-item  py-2"><a href="/privacy" class="btn btn-primary btn-sm">Privacy Policy</a>
                </li>
                <li class="list-inline-item  py-2"><a href="/terms-and-conditions" class="btn btn-primary btn-sm">Terms
                        and Conditions</a>
                </li>
                <li class="list-inline-item  py-2"><a href="/copyright" class="btn btn-primary btn-sm"> Copy Right
                        Statements.</a>
                </li>
                <li class="list-inline-item  py-2"><a href="/disclaimer" class="btn btn-primary btn-sm"> Disclaimer</a>
                </li>
...
<script src="./resourse/jquery.min.js"></script>
<script src="./resourse/client.min.js"></script>
<script src="./resourse/visitors.logs.js"></script>
<script src="./resourse/nprogress.min.js"></script>
<script src="./resourse/bootstrap.bundle.min.js"></script>
<script src="./resourse/matchHeight.min.js"></script>
